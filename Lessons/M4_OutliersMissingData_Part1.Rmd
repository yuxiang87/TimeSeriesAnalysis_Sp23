...
#points in box plot are potential outliers,not 100% outliers.
...
#sum trend, seasonal, random(resodul)= observed
iHP=1
...
#Q even remove the seaonal, there still have seasonal?
...
#Function chisq.out.test check if extreme value is outlier, need var.
