...
# each bar= autCor, value 1~-1. seasonal.
#blue dot line, in the line = not significant. 
...
```{r}
N2011_inflow_data <- inflow_data[1:(nobs-12),]
test_inflow_data <- inflow_data[1:960,]
