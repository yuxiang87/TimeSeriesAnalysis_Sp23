...
#note: seasadj,only work for decompose result
...
#Note: decrease the ACF value of lag1
...
#note: coeficc- 0.23, -0.37..;AIC,AICc(for small data set); 


#Check residuals series, if white noise we got a good fit
#note: hope all value is not sig:all in blue lines; best is the lowest AIC
par(mar=c(3,3,3,0));par(mfrow=c(1,3))
...
#note: d=1 means, arima also do a differnecing, therefore, still use diff data. 
