...
```{r}
adf.test(residential_price_seas_diff)
#p value>0.05-
...
#note---SARIMA might better, for both 
```
...
#noteAIC can be postive and negative, this one is lowest---(-234.11)
