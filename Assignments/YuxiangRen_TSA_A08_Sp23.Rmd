...
raw_inflow_10 <- filter(raw_clean, Date >= "2010-01-01" & Date <= "2010-12-01")

#ts
ts_09 <- ts(raw_inflow_09$V15, start = c(2000,1), frequency = 12)
par(mfrow = c(1,3))
plot(ts_09, main = "monthly inflow for one hydro power plant in Brazil")
acf(ts_09, main = "ACF")
...
par(mfrow = c(1,3))
plot(ts_09_desea, main = "monthly inflow (deseasonlized) for one hydro power plant in Brazil")
