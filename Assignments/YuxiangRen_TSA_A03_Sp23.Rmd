...
rawdata <- read.xlsx(file="./Data/Table_10.1_Renewable_Energy_Production_and_Consumption_by_Source.xlsx",header=FALSE,startRow = 13,sheetIndex=1) 
...
Acf(ts_A03[,"Total Biomass Energy Production"],lag.max=40,main=paste("Total biomass energy production"))
...
Acf(ts_A03[,"Total Renewable Energy Production"],lag.max=40,main=paste("Total Renewable Energy Production"))
...
Acf(ts_A03[,"Hydroelectric Power Consumption"],lag.max=40,main=paste("Hydroelectric Power Consumption"))
