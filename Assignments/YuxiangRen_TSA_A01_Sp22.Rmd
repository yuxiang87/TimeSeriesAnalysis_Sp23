...
> Answer: No time series analysis experiences. However, I used r in a previous statistics class. But instead of learning r systematically, I just used r to demonstrate some knowledge of statistics. I also enrol the 872 this semester to learn R and Git.
...
> Answer: 
https://github.com/yuxiang87/TimeSeriesAnalysis_Sp23.git
